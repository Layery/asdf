...
<div class="form">
    ...
    <? if ($item->sex == 1){ ?>
     <div class="row" id="sex">
        性别:　　男:<input type="radio" name="Student[sex]" class="Student_sex" value="1" checked>女:<input type="radio" name="Student[sex]" class="Student_sex" value="2">
     </div>
    
    <? }else{ ?>
    <div class="row" id="sex">
        性别:　　男:<input type="radio" name="Student[sex]" class="Student_sex" value="1">女:<input type="radio" name="Student[sex]" class="Student_sex" value="2" checked>
    </div>
    <?}?>
